...
parser.add_argument('--src_dir', default='D:/NCHU/Dataset/Denoise/DIV2K/dfads', type=str, help='Directory for full resolution images')
parser.add_argument('--tar_dir', default='D:/PycharmProjects/FCMNet-main/data_prep/DIV2K_denoising/train',type=str, help='Directory for image patches')
