...
def get_training_data(rgb_dir, img_options):
    # find the line with: assert os.path.exists(rgb_dir)
    print("DEBUG: rgb_dir =", rgb_dir, "exists?", os.path.exists(rgb_dir))
    assert os.path.exists(rgb_dir), f"rgb_dir not found: {rgb_dir}"
